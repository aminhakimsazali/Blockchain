App = {
  ...
  verificationRecipient : function(){
    ...
    App.contracts.SmartZakat.deployed().then(function(instance) {
      ...
      alert("The recipient is valid B40");
      else{
        alert("The recipient is NOT   valid B40");
      }
  ...
  getUserFund : function(){
    ...
    App.contracts.SmartZakat.deployed().then(function(instance) {
      ...
      var object = zakatInstance.getFund(icforFund,0);

      
            return object;
          
    }).then(function(detail){
      document.getElementById('fund1-1').innerHTML = detail[1];
      document.getElementById('fund1-2').innerHTML = detail[2];
      document.getElementById('fund1-3').innerHTML = detail[3];
      console.log("Detail at 0: " + detail);
    }).then(function(counter){
      var object = zakatInstance.getFund(icforFund,1);
            // console.log("Fund at 1: " + zakatInstance.getFund(icforFund,1));
            // console.log("Object 1: " + object);
            return object;

    }).then(function(detail){
      document.getElementById('fund2-1').innerHTML = detail[1];
      document.getElementById('fund2-2').innerHTML = detail[2];
      document.getElementById('fund2-3').innerHTML = detail[3];
      console.log("Detail at 1: " + detail);
    }).then(function(counter){
      var object = zakatInstance.getFund(icforFund,2);
            // console.log("Fund at 2: " + zakatInstance.getFund(icforFund,2));
            // console.log("Object 2: " + object);
            return object;

    }).then(function(detail){
      document.getElementById('fund3-1').innerHTML = detail[1];
      document.getElementById('fund3-2').innerHTML = detail[2];
      document.getElementById('fund3-3').innerHTML = detail[3];
      console.log("Detail at 2: " + detail);
    }).then(function(counter){
      var object = zakatInstance.getFund(icforFund,3);
            // console.log("Fund at 3: " + zakatInstance.getFund(icforFund,3));
            // console.log("Object 3: " + object);
            return object;

    }).then(function(detail){
      document.getElementById('fund4-1').innerHTML = detail[1];
      document.getElementById('fund4-2').innerHTML = detail[2];
      document.getElementById('fund4-3').innerHTML = detail[3];
      console.log("Detail at 3: " + detail);
    })
